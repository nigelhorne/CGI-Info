...
PARAMS: {
	...
	# SQL Injection is prevented
	$ENV{'QUERY_STRING'} = "surname='Stock%20or%20(1,2\)=(SELECT*from(select%20name_const(CHAR(111,108,111,108,111,115,104,101,114\),1\),name_const(CHAR( <-- HERE 111,108,111,108,111,115,104,101,114\),1\)\)a\)%20--%20and%201%3D1'";
	$i = new_ok('CGI::Info');
	ok(!defined($i->params()));
